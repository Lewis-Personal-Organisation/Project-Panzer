...
public class LobbyManager : Singleton<LobbyManager>
{
	...
	public static class RateLimits
	{
		...
		{
			{ RequestType.UpdatePlayers, 1F },
			{ RequestType.UpdateLobbies, 1F },
			{ RequestType.DeleteLobby, 2F },
			{ RequestType.LeaveOrRemovePlayers, 5F},
		};
	...
	/// </summary>
	/// <returns></returns>
	public Player CacheLocalPlayer()
	{
		if (activeLobby == null)
			return null;
