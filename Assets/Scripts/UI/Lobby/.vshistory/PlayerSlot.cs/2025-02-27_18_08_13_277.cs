...
public class PlayerSlot : MonoBehaviour
{
	...
	private IEnumerator IScale(bool isMouseHovering)
	{
		startSize = isMouseHovering ? baseSize : endSize;
		endSize = isMouseHovering ? endSize : baseSize;
		float t = 0;

		while (t < 1)
		{
			t += Time.deltaTime;
			parentRectTransform.sizeDelta = Vector2.Lerp(startSize, endSize, t);
			yield return null;
		}

		parentRectTransform.sizeDelta = Vector2.Lerp(startSize, endSize, 1);
	}
