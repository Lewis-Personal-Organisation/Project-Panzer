...
public class LobbySetupUI : Panel
{
	...
	private void Awake()
	{
		...
		{ 
			...
			transitionButtons = StartCoroutine(UIManager.Instance.LerpImageColours(new UIManager.LerpGroup[]
			{
				new UIManager.LerpGroup(.2F, privateButton.image, selectableButtonFromColour, selectableButtonToColour),
				new UIManager.LerpGroup(.2F, publicButton.image, selectableButtonToColour, selectableButtonFromColour),
